class FavoriteMoviesByUsersController < ApplicationController
  ...
  def create
    ...
    redirect_to request.referer || movie_path(@movie.api_movie_id), notice: "Movie added to favorite"
  end
  ...
  def destroy
    ...
    redirect_to request.referer || movie_path(@movie.api_movie_id), notice: "Movie removed from favorite"
  end
end
